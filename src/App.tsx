...
function App() {
  ...
  return (
    <div className={`min-h-screen bg-white transition-opacity duration-1000 ${showContent ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="text-2xl font-light tracking-wider text-amber-700">
                  <span className="font-normal">KSM</span>
                  <div className="text-xs text-gray-600 tracking-widest mt-1">CAPITAL</div>
                </div>
              </div>
            </div>
            ...
            <div className="hidden lg:block">
              <div className="ml-10 flex items-baseline space-x-8">
                <button className="text-gray-700 hover:text-amber-700 px-3 py-2 text-sm font-medium tracking-wide transition-colors">
                  WEALTH MANAGEMENT
                </button>
                <button className="text-gray-700 hover:text-amber-700 px-3 py-2 text-sm font-medium tracking-wide transition-colors">
                  ASSET MANAGEMENT
                ...
                <button className="border border-gray-300 text-gray-700 hover:border-amber-700 hover:text-amber-700 px-4 py-2 text-sm font-medium tracking-wide transition-colors">
                  CLIENT LOGIN
                </button>
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-white border-t border-gray-200">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <button className="block px-3 py-2 text-gray-700 hover:text-amber-700 w-full text-left text-sm tracking-wide">
                WEALTH MANAGEMENT
              </button>
              <button className="block px-3 py-2 text-gray-700 hover:text-amber-700 w-full text-left text-sm tracking-wide">
                ASSET MANAGEMENT
      ...
      <section className="pt-20 bg-gradient-to-br from-teal-800 via-teal-700 to-teal-900 min-h-screen relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-40 left-1/4 w-20 h-20 bg-blue-400 rounded-full"></div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
            ...
            <div className="text-white space-y-12">
              <div>
                ...
                <button className="text-white border-b border-white pb-1 hover:border-amber-400 hover:text-amber-400 transition-colors flex items-center space-x-2 text-sm tracking-wide">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-5">
          <div className="grid grid-cols-20 gap-4 h-full">
            {Array.from({ length: 400 }).map((_, i) => (
              <div key={i} className="w-1 h-1 bg-amber-700 rounded-full"></div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-5xl lg:text-6xl font-light text-amber-700 leading-tight mb-8">
                Expect the<br />
                <span className="border-b-2 border-amber-700 pb-2">Exceptional</span>
              </h2>
              ...
              <button className="border border-amber-700 text-amber-700 px-8 py-3 hover:bg-amber-700 hover:text-white transition-colors text-sm tracking-wide">
                WHO WE ARE
              </button>
            </div>
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white/90 p-4 rounded-lg">
                <div className="text-amber-700 font-script text-2xl">KSM Capital</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {/* Wealth Management */}
            <div className="bg-green-800 text-white p-8 rounded-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <button className="text-white border-b border-white pb-1 hover:border-green-300 transition-colors flex items-center space-x-2 text-sm tracking-wide">
            ...
            {/* Asset Management */}
            <div className="bg-amber-800 text-white p-8 rounded-lg hover:shadow-xl transition-shadow duration-300 relative overflow-hidden">
              ...
              <p className="text-amber-100 mb-8 leading-relaxed relative z-10">
              ...
              <button className="text-white border-b border-white pb-1 hover:border-amber-300 transition-colors flex items-center space-x-2 text-sm tracking-wide relative z-10">
            ...
            <div className="bg-teal-800 text-white p-8 rounded-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <button className="text-white border-b border-white pb-1 hover:border-teal-300 transition-colors flex items-center space-x-2 text-sm tracking-wide">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-gray-900 mb-4">Updates</h2>
            ...
            <div className="updates-track animate-scroll">
              {[
                ...
                <div key={index} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex-shrink-0 w-80">
                  <div className="text-amber-700 text-sm font-medium mb-2">{update.date}</div>
                  <h3 className="text-lg font-medium text-gray-900 mb-3 whitespace-normal">{update.title}</h3>
                  <p className="text-gray-600 text-sm leading-relaxed mb-4 whitespace-normal">{update.excerpt}</p>
                  <button className="text-amber-700 text-sm font-medium hover:text-amber-800 transition-colors flex items-center space-x-1">
                    <span>Read More</span>
                    <ArrowRight size={14} />
                  </button>
                </div>
      ...
      {/* Contact Section */}
      <section className="py-20 bg-gradient-to-br from-blue-900 via-purple-900 to-teal-900 relative overflow-hidden">
        {/* Abstract background */}
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-yellow-400 via-green-400 to-blue-400 mix-blend-overlay"></div>
        </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl">
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-0 py-3 border-0 border-b border-gray-300 focus:border-amber-700 focus:ring-0 bg-transparent"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select className="w-full px-0 py-3 border-0 border-b border-gray-300 focus:border-amber-700 focus:ring-0 bg-transparent">
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    className="w-full px-0 py-3 border-0 border-b border-gray-300 focus:border-amber-700 focus:ring-0 bg-transparent resize-none"
                  ></textarea>
                </div>
                <button
                  type="submit"
                  className="w-full bg-amber-700 text-white py-4 rounded-lg font-medium hover:bg-amber-800 transition-colors tracking-wide"
                >
                  SUBMIT
                </button>
              </form>
      ...
      <footer className="bg-gray-900 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="text-2xl font-light tracking-wider text-amber-700 mb-4">
              <span className="font-normal">KSM</span>
              <div className="text-xs text-gray-400 tracking-widest mt-1">CAPITAL</div>
            </div>
